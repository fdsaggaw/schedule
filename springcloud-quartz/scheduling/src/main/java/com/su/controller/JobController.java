...
import com.su.constant.JobConstant;
...
import com.su.service.JobManagerService;
...
public class JobController {
    ...
    public ResultVO pageJob(JobInfoQuery jobInfoQuery) {
        System.out.println(jobInfoQuery.getLimit());
        System.out.println(jobInfoQuery.getPage());
